"""Evaluate a 2D downstream checkpoint with task-specific segmentation metrics."""
...
def parse_args() -> argparse.Namespace:
    ...
    add_common_arguments(parser, "configs/table1_2d.yaml", ("dataset", "downstream", "evaluation"))
...
def evaluate(config, phase: str):
    ...
    result = evaluate_segmentation(config, 2)
    print(result)
    return result
