"""Train a 2D real baseline or real-plus-synthetic continuation."""
...
def parse_args() -> argparse.Namespace:
    ...
    add_common_arguments(parser, "configs/table1_2d.yaml", ("dataset", "downstream"))
...
if __name__ == "__main__":
    ...
    run_configured(
        arguments,
        lambda config: run_downstream_training(config, 2, arguments.phase),
