"""NAM real-plus-synthetic continuation for DeepLabV3-ResNet50."""
...
def train_synthetic(config: Any, spatial_dims: int) -> Path:
    return train_natural_segmentation(
        config, spatial_dims, "deeplabv3", build_model, "synthetic"
    )


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Continue DeepLabV3 with NAM samples.")
