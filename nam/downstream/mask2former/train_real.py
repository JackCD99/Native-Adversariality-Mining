"""Real-data training pipeline for Mask2Former-ResNet50."""
...
def train_real(config: Any, spatial_dims: int) -> Path:
    return train_natural_segmentation(config, spatial_dims, "mask2former", build_model, "real")


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Mask2Former on real VOC/SBD data.")
