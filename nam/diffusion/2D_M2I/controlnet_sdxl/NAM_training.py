"""ControlNet-SDXL-specific entry point for Native Adversariality Mining."""
...
def train_nam(config: Any) -> Path | None:
    """Train the ControlNet-SDXL adversariality miner with frozen generator and anchor."""
    return run_miner_training(config, spatial_dims=2)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train NAM for ControlNet-SDXL.")
