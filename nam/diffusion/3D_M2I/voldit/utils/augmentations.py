"""Condition-only 3D augmentation used for fixed-budget VolDiT synthesis."""
...
class VolDiTConditionAugmentation:
    """Apply the paper's random horizontal flip and isotropic mask scaling."""
