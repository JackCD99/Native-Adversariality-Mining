"""Train the explicit volumetric ResUNet miner for frozen MAISI."""
...
def train_nam(config):
    """Train the volumetric ResUNet miner used by the MAISI adapter."""
    return run_miner_training(config, spatial_dims=3)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the volumetric NAM ResUNet for MAISI.")
